...
This fork extends ASCAM to read **ABF (Axon Binary Format)** files natively, adds an 8-pole Bessel filter based on standard single-channel methods (Colquhoun & Sigworth, *Single-Channel Recording*, 2e, ch. 19), and improves plotting of large continuous recordings.
...
### 3. Smoother plotting of large/continuous recordings
...
- Extra packages used by the additions: `pip install pyabf`.
